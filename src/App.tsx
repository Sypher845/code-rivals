            ...
            <main className="grid min-h-screen place-items-center px-6">
              <div className="w-full max-w-xl rounded-3xl border border-[var(--arena-border)] bg-[var(--arena-surface-1)] p-8 shadow-[0_24px_64px_rgba(0,0,0,0.34)]">
                ...
                <p className="mt-4 text-[var(--text-secondary)]">
                  Login and signup are wired up. This temporary screen can be
                  replaced later with the actual app.
                </p>
                <div className="mt-6 rounded-2xl border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] px-4 py-3 font-[var(--font-mono)] text-sm tracking-[0.08em] text-[rgba(241,243,252,0.72)] uppercase">
